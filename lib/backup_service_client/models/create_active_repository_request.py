...
class CreateActiveRepositoryRequest(object):
    ...
    def __init__(self, plan=None, archive=None, bucket_name=None, cloud_credential_name=None, cloud_staging_dir=None, cloud_credentials_id=None, cloud_credentials_key=None, cloud_region=None, cloud_endpoint=None, cloud_force_path_style=None):  # noqa: E501
        """CreateActiveRepositoryRequest - a model defined in Swagger"""  # noqa: E501
        self._plan = None
        self._archive = None
    ...
    @property
    def plan(self):
        """Gets the plan of this CreateActiveRepositoryRequest.  # noqa: E501

        The plan to use as base  # noqa: E501

        :return: The plan of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
        return self._plan
    ...
    @plan.setter
    def plan(self, plan):
        """Sets the plan of this CreateActiveRepositoryRequest.

        The plan to use as base  # noqa: E501

        :param plan: The plan of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
        if plan is None:
    ...
    @property
    def archive(self):
        """Gets the archive of this CreateActiveRepositoryRequest.  # noqa: E501

        The location to use as backup archive  # noqa: E501

        :return: The archive of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def archive(self, archive):
        """Sets the archive of this CreateActiveRepositoryRequest.

        The location to use as backup archive  # noqa: E501

        :param archive: The archive of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
        if archive is None:
    ...
    def bucket_name(self):
        """Gets the bucket_name of this CreateActiveRepositoryRequest.  # noqa: E501

        Wheter or not this repository applies to one bucket or the whole cluster.  # noqa: E501

        :return: The bucket_name of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def bucket_name(self, bucket_name):
        """Sets the bucket_name of this CreateActiveRepositoryRequest.

        Wheter or not this repository applies to one bucket or the whole cluster.  # noqa: E501

        :param bucket_name: The bucket_name of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_credential_name(self):
        """Gets the cloud_credential_name of this CreateActiveRepositoryRequest.  # noqa: E501
        ...
        :return: The cloud_credential_name of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_credential_name(self, cloud_credential_name):
        """Sets the cloud_credential_name of this CreateActiveRepositoryRequest.

        Use a set of already registered credentials. This option is mutually exclusive to the cloud_credentials_key and cloud_credentials_id and one of those sets must be provided for repositories in the cloud.  # noqa: E501

        :param cloud_credential_name: The cloud_credential_name of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_staging_dir(self):
        """Gets the cloud_staging_dir of this CreateActiveRepositoryRequest.  # noqa: E501

        The location to use as a staging directory. It is required for repositories in the cloud.  # noqa: E501

        :return: The cloud_staging_dir of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_staging_dir(self, cloud_staging_dir):
        """Sets the cloud_staging_dir of this CreateActiveRepositoryRequest.

        The location to use as a staging directory. It is required for repositories in the cloud.  # noqa: E501

        :param cloud_staging_dir: The cloud_staging_dir of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_credentials_id(self):
        """Gets the cloud_credentials_id of this CreateActiveRepositoryRequest.  # noqa: E501

        The ID used to connect to object store.  # noqa: E501

        :return: The cloud_credentials_id of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_credentials_id(self, cloud_credentials_id):
        """Sets the cloud_credentials_id of this CreateActiveRepositoryRequest.

        The ID used to connect to object store.  # noqa: E501

        :param cloud_credentials_id: The cloud_credentials_id of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_credentials_key(self):
        """Gets the cloud_credentials_key of this CreateActiveRepositoryRequest.  # noqa: E501

        The secret key used to connect to object store.  # noqa: E501

        :return: The cloud_credentials_key of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_credentials_key(self, cloud_credentials_key):
        """Sets the cloud_credentials_key of this CreateActiveRepositoryRequest.

        The secret key used to connect to object store.  # noqa: E501

        :param cloud_credentials_key: The cloud_credentials_key of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_region(self):
        """Gets the cloud_region of this CreateActiveRepositoryRequest.  # noqa: E501

        The region of the cloud bucket.  # noqa: E501

        :return: The cloud_region of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_region(self, cloud_region):
        """Sets the cloud_region of this CreateActiveRepositoryRequest.

        The region of the cloud bucket.  # noqa: E501

        :param cloud_region: The cloud_region of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_endpoint(self):
        """Gets the cloud_endpoint of this CreateActiveRepositoryRequest.  # noqa: E501

        If provided it overrides the default endpoint use for the cloud provider.  # noqa: E501

        :return: The cloud_endpoint of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_endpoint(self, cloud_endpoint):
        """Sets the cloud_endpoint of this CreateActiveRepositoryRequest.

        If provided it overrides the default endpoint use for the cloud provider.  # noqa: E501

        :param cloud_endpoint: The cloud_endpoint of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_force_path_style(self):
        """Gets the cloud_force_path_style of this CreateActiveRepositoryRequest.  # noqa: E501

        When provided and using S3 or S3 compatible storages it will use the old S3 path style.  # noqa: E501

        :return: The cloud_force_path_style of this CreateActiveRepositoryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_force_path_style(self, cloud_force_path_style):
        """Sets the cloud_force_path_style of this CreateActiveRepositoryRequest.

        When provided and using S3 or S3 compatible storages it will use the old S3 path style.  # noqa: E501

        :param cloud_force_path_style: The cloud_force_path_style of this CreateActiveRepositoryRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateActiveRepositoryRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateActiveRepositoryRequest):
            return False
