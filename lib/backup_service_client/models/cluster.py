...
class Cluster(object):
    ...
    @property
    def archived(self):
        """Gets the archived of this Cluster.  # noqa: E501

        A map of archived repository name to repository  # noqa: E501

        :return: The archived of this Cluster.  # noqa: E501
        :rtype: dict(str, Repository)
        """
    ...
    def archived(self, archived):
        """Sets the archived of this Cluster.

        A map of archived repository name to repository  # noqa: E501

        :param archived: The archived of this Cluster.  # noqa: E501
        :type: dict(str, Repository)
        """
    ...
    @property
    def active(self):
        """Gets the active of this Cluster.  # noqa: E501

        A map of active repository name to repository  # noqa: E501

        :return: The active of this Cluster.  # noqa: E501
        :rtype: dict(str, Repository)
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this Cluster.

        A map of active repository name to repository  # noqa: E501

        :param active: The active of this Cluster.  # noqa: E501
        :type: dict(str, Repository)
        """
