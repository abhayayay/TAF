...
class ImportRequest(object):
    ...
    def __init__(self, id=None, repo=None, archive=None, cloud_credential_name=None, cloud_staging_dir=None, cloud_credentials_id=None, cloud_credentials_key=None, cloud_region=None, cloud_endpoint=None, cloud_force_path_style=None):  # noqa: E501
        """ImportRequest - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._repo = None
        self._archive = None
    ...
    @property
    def id(self):
        """Gets the id of this ImportRequest.  # noqa: E501

        The id to assign to this imported repository  # noqa: E501

        :return: The id of this ImportRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ImportRequest.

        The id to assign to this imported repository  # noqa: E501

        :param id: The id of this ImportRequest.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def repo(self):
        """Gets the repo of this ImportRequest.  # noqa: E501

        The repo to import  # noqa: E501

        :return: The repo of this ImportRequest.  # noqa: E501
        :rtype: str
        """
        return self._repo
    ...
    @repo.setter
    def repo(self, repo):
        """Sets the repo of this ImportRequest.

        The repo to import  # noqa: E501

        :param repo: The repo of this ImportRequest.  # noqa: E501
        :type: str
        """
        if repo is None:
    ...
    @property
    def archive(self):
        """Gets the archive of this ImportRequest.  # noqa: E501

        The archive in which the repo is located  # noqa: E501

        :return: The archive of this ImportRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def archive(self, archive):
        """Sets the archive of this ImportRequest.

        The archive in which the repo is located  # noqa: E501

        :param archive: The archive of this ImportRequest.  # noqa: E501
        :type: str
        """
        if archive is None:
    ...
    def cloud_credential_name(self):
        """Gets the cloud_credential_name of this ImportRequest.  # noqa: E501
        ...
        :return: The cloud_credential_name of this ImportRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_credential_name(self, cloud_credential_name):
        """Sets the cloud_credential_name of this ImportRequest.

        Use a set of already registered credentials. This option is mutually exclusive to the cloud_credentials_key and cloud_credentials_id and one of those sets must be provided for repositories in the cloud.  # noqa: E501

        :param cloud_credential_name: The cloud_credential_name of this ImportRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_staging_dir(self):
        """Gets the cloud_staging_dir of this ImportRequest.  # noqa: E501

        The location to use as a staging directory. It is required for repositories in the cloud.  # noqa: E501

        :return: The cloud_staging_dir of this ImportRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_staging_dir(self, cloud_staging_dir):
        """Sets the cloud_staging_dir of this ImportRequest.

        The location to use as a staging directory. It is required for repositories in the cloud.  # noqa: E501

        :param cloud_staging_dir: The cloud_staging_dir of this ImportRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_credentials_id(self):
        """Gets the cloud_credentials_id of this ImportRequest.  # noqa: E501

        The ID used to connect to object store.  # noqa: E501

        :return: The cloud_credentials_id of this ImportRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_credentials_id(self, cloud_credentials_id):
        """Sets the cloud_credentials_id of this ImportRequest.

        The ID used to connect to object store.  # noqa: E501

        :param cloud_credentials_id: The cloud_credentials_id of this ImportRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_credentials_key(self):
        """Gets the cloud_credentials_key of this ImportRequest.  # noqa: E501

        The secret key used to connect to object store.  # noqa: E501

        :return: The cloud_credentials_key of this ImportRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_credentials_key(self, cloud_credentials_key):
        """Sets the cloud_credentials_key of this ImportRequest.

        The secret key used to connect to object store.  # noqa: E501

        :param cloud_credentials_key: The cloud_credentials_key of this ImportRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_region(self):
        """Gets the cloud_region of this ImportRequest.  # noqa: E501

        The region of the cloud bucket.  # noqa: E501

        :return: The cloud_region of this ImportRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_region(self, cloud_region):
        """Sets the cloud_region of this ImportRequest.

        The region of the cloud bucket.  # noqa: E501

        :param cloud_region: The cloud_region of this ImportRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_endpoint(self):
        """Gets the cloud_endpoint of this ImportRequest.  # noqa: E501

        If provided it overrides the default endpoint use for the cloud provider.  # noqa: E501

        :return: The cloud_endpoint of this ImportRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_endpoint(self, cloud_endpoint):
        """Sets the cloud_endpoint of this ImportRequest.

        If provided it overrides the default endpoint use for the cloud provider.  # noqa: E501

        :param cloud_endpoint: The cloud_endpoint of this ImportRequest.  # noqa: E501
        :type: str
        """
    ...
    def cloud_force_path_style(self):
        """Gets the cloud_force_path_style of this ImportRequest.  # noqa: E501

        When provided and using S3 or S3 compatible storages it will use the old S3 path style.  # noqa: E501

        :return: The cloud_force_path_style of this ImportRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_force_path_style(self, cloud_force_path_style):
        """Sets the cloud_force_path_style of this ImportRequest.

        When provided and using S3 or S3 compatible storages it will use the old S3 path style.  # noqa: E501

        :param cloud_force_path_style: The cloud_force_path_style of this ImportRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ImportRequest, dict):
