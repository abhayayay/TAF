...
class RepositoryCloudInfo(object):
    ...
    def __init__(self, credentials_name=None, staging_dir=None, region=None, endpoint=None, force_path_style=None, provider=None):  # noqa: E501
    ...
    @property
    def region(self):
        """Gets the region of this RepositoryCloudInfo.  # noqa: E501

        The region for the cloud container. For example the region the S3 bucket is in.  # noqa: E501

        :return: The region of this RepositoryCloudInfo.  # noqa: E501
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        """Sets the region of this RepositoryCloudInfo.

        The region for the cloud container. For example the region the S3 bucket is in.  # noqa: E501

        :param region: The region of this RepositoryCloudInfo.  # noqa: E501
        :type: str
        """
