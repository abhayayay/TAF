...
import backup_service_client.models
from backup_service_client import rest
from tasks.async_result import AsyncResult
...
class ApiClient(object):
    ...
    def __call_api(
        ...
        response_data = self.request(
            ...
            _request_timeout=_request_timeout, no_api_exception=_return_http_data_only is None)
    ...
    def call_api(self, resource_path, method,
        ...
        """
        args = (resource_path, method, path_params, query_params, header_params, body, post_params, files,
    ...
    def request(self, method, url, query_params=None, headers=None,
        ...
        if method == "GET":
            return self.rest_client.GET(url,
                                        ...
                                        headers=headers, no_api_exception=no_api_exception)
        elif method == "HEAD":
            return self.rest_client.HEAD(url,
                                         query_params=query_params,
                                         _preload_content=_preload_content,
                                         _request_timeout=_request_timeout,
                                         headers=header, no_api_exception=no_api_exception)
        elif method == "OPTIONS":
