...
class ConfigurationApi(object):
    ...
    def config_get(self, **kwargs):  # noqa: E501
        """Get service configuration  # noqa: E501
    ...
    def config_patch(self, **kwargs):  # noqa: E501
        """Modifies the configuration. Any parameter not provided will not be modified  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.config_patch(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ServiceConfiguration body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.config_patch_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.config_patch_with_http_info(**kwargs)  # noqa: E501
            return data

    def config_patch_with_http_info(self, **kwargs):  # noqa: E501
        """Modifies the configuration. Any parameter not provided will not be modified  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.config_patch_with_http_info(async_req=True)
        >>> result = thread.get()
