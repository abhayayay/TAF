...
class RepositoryApi(object):
    ...
    def cluster_self_repository_state_id_check_access_get(self, state, id, **kwargs):  # noqa: E501
        """Check if the node still has access to the underlying cbbackupmgr repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_self_repository_state_id_check_access_get(state, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cluster_self_repository_state_id_check_access_get_with_http_info(state, id, **kwargs)  # noqa: E501
        else:
            (data) = self.cluster_self_repository_state_id_check_access_get_with_http_info(state, id, **kwargs)  # noqa: E501
            return data

    def cluster_self_repository_state_id_check_access_get_with_http_info(self, state, id, **kwargs):  # noqa: E501
        """Check if the node still has access to the underlying cbbackupmgr repository  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cluster_self_repository_state_id_check_access_get_with_http_info(state, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cluster_self_repository_state_id_check_access_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'state' is set
        if ('state' not in params or
                params['state'] is None):
            raise ValueError("Missing the required parameter `state` when calling `cluster_self_repository_state_id_check_access_get`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `cluster_self_repository_state_id_check_access_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cluster/self/repository/{state}/{id}/checkAccess', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
